        ...
        <div class="product_list">
            ...
            <div class="product_list_item">
                <div class="product_list_subcontainer">
                    <img src="<?php bloginfo('template_url'); ?>/img/products/salad/pic1.png">
                    <p class="product_title">ПАНЦАНЕЛА</p>
            ...
            <div class="product_list_item">
                <div class="product_list_subcontainer">
                    <img src="<?php bloginfo('template_url'); ?>/img/products/salad/pic2.png">
                    <p class="product_title">ГРЕЦЬКИЙ</p>
                    <div class="product_more_info">
                        <span>20см\350г</span> ТоМАТНА ОСНОВА, СОУС ШРІРАЧА, МОЦАРЕЛА, САЛЯМІ ПАПЕРОНІ
                    </div>
                    <div class="product_additional_info">
